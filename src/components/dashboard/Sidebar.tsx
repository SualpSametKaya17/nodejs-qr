        ...
        {role === "superadmin" && (() => {
          ...
          return (
            <Link
              href={href}
              onClick={onClose}
              className={`flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors mt-2 border-t border-gray-100 pt-3 ${
                isActive
            ...
            >
              ...
              <span className="flex-1">Süper Admin</span>
            </Link>
          );
        })()}
      </nav>
